...
data1=change_row_to_column_Neuron2020(data1);
data2=change_row_to_column_Neuron2020(data2);
if nargin < 3; params=[]; end;
[tapers,pad,Fs,fpass,err,trialave]=getparams_Neuron2020(params);
...
N=check_consistency_Neuron2020(data1,data2);
nfft=max(2^(nextpow2(N)+pad),N);
[f,findx]=getfgrid_Neuron2020(Fs,nfft,fpass); 
tapers=dpsschk_Neuron2020(tapers,N,Fs); % check tapers
J1=mtfftc_Neuron2020(data1,tapers,nfft,Fs);
J2=mtfftc_Neuron2020(data2,tapers,nfft,Fs);
...
phi=angle(C12);
if nargout>=9; 
     [confC,phistd,Cerr]=coherr_Neuron2020(C,J1,J2,err,trialave);
elseif nargout==8;
     [confC,phistd]=coherr_Neuron2020(C,J1,J2,err,trialave);
end;
