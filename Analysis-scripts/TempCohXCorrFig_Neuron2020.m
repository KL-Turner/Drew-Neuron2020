function TempCohXCorrFig_Neuron2020(ComparisonData)
...
hold on
plot(lags,angleXC_Mean + angleXC_StErr,'Color',colors_Neuron2020('ash grey'))
plot(lags,angleXC_Mean - angleXC_StErr,'Color',colors_Neuron2020('ash grey'))
xlabel('Lags (s)')
...
hold on
plot(lags,velocityXC_Mean + velocityXC_StErr,'Color',colors_Neuron2020('ash grey'))
plot(lags,velocityXC_Mean - velocityXC_StErr,'Color',colors_Neuron2020('ash grey'))
xlabel('Lags (s)')
...
hold on
plot(lags,accelXC_Mean + accelXC_StErr,'Color',colors_Neuron2020('ash grey'))
plot(lags,accelXC_Mean - accelXC_StErr,'Color',colors_Neuron2020('ash grey'))
xlabel('Lags (s)')
...
hold on
plot(lags,movementXC_Mean + movementXC_StErr,'Color',colors_Neuron2020('ash grey'))
plot(lags,movementXC_Mean - movementXC_StErr,'Color',colors_Neuron2020('ash grey'))
xlabel('Lags (s)')
...
hold on
plot(f1,angleCoherenceMean + angleCoherenceStErr,'Color',colors_Neuron2020('ash grey'))
plot(f1,angleCoherenceMean - angleCoherenceStErr,'Color',colors_Neuron2020('ash grey'))
conf = plot(f1,confInterval_Y,'--','Color',colors_Neuron2020('vegas gold'),'LineWidth',2);
xlabel('Frequency (Hz)')
...
hold on
plot(f1,velocityCoherenceMean + velocityCoherenceStErr,'Color',colors_Neuron2020('ash grey'))
plot(f1,velocityCoherenceMean - velocityCoherenceStErr,'Color',colors_Neuron2020('ash grey'))
conf = plot(f1,confInterval_Y,'--','Color',colors_Neuron2020('vegas gold'),'LineWidth',2);
xlabel('Frequency (Hz)')
...
hold on
plot(f1,accelCoherenceMean + accelCoherenceStErr,'Color',colors_Neuron2020('ash grey'))
plot(f1,accelCoherenceMean - accelCoherenceStErr,'Color',colors_Neuron2020('ash grey'))
conf = plot(f1,confInterval_Y,'--','Color',colors_Neuron2020('vegas gold'),'LineWidth',2);
xlabel('Frequency (Hz)')
...
hold on
plot(f1,movementCoherenceMean + movementCoherenceStErr,'Color',colors_Neuron2020('ash grey'))
plot(f1,movementCoherenceMean - movementCoherenceStErr,'Color',colors_Neuron2020('ash grey'))
conf = plot(f1,confInterval_Y,'--','Color',colors_Neuron2020('vegas gold'),'LineWidth',2);
xlabel('Frequency (Hz)')
