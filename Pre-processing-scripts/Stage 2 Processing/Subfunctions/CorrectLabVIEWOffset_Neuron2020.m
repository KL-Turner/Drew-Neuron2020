function [] = CorrectLabVIEWOffset_Neuron2020(labviewDataFiles,mscanDataFiles,trimTime)
...
for a = 1:size(mscanDataFiles,1)
    ...
    if MScanData.notes.checklist.offsetCorrect == false
        ...
        [animalID,hem,fileDate,fileID] = GetFileInfo_Neuron2020(labviewDataFile);
