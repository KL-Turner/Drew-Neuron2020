function [diamPerc, S, f] = DiamPercPower_SlowOscReview2019(rawDiameter, baseDiameter, samplingRate)
...
%________________________________________________________________________________________________________________________
%
%   Inputs: raw diameter, baseline, fs.
%
%   Outputs: Diameter spectral power.
%
...
params.err = [1 .01];
params.fpass = [0.05 3];
[S,f,~] = mtspectrumc_SlowOscReview2019(diamPerc - mean(diamPerc), params);
